...
g1 <- ggplot(data = pd1, aes(x = t, y = value/target_pop * 1e6, col = factor(Rt1))) +
  ...
  geom_vline(xintercept = 60+61, linetype = "dotted") +
  geom_vline(xintercept = 60+61+304, linetype = "dotted") +
  geom_vline(xintercept = 60+61+304+122, linetype = "dotted") +
  geom_vline(xintercept = 60+61+304+122+184, linetype = "dotted") +
  ...
  annotate(geom = "text", x = 60, label="\nR0 = 2.5", y=80, colour="darkgrey", angle=90) +
  annotate(geom = "text", x = 60+61, label="\nRt1 start", y=80, colour="darkgrey", angle=90) +
  annotate(geom = "text", x = 60+61+304, label="\nVaccination start", y=80, colour="darkgrey", angle=90) +
  annotate(geom = "text", x = 60+61+304+122, label="Vaccination stop\n", y=80, colour="darkgrey", angle=90) +
  annotate(geom = "text", x = 60+61+304+122, label="\n Increase Rt start", y=80, colour="darkgrey", angle=90) +
  annotate(geom = "text", x = 60+61+304+122+184, label="\n Rt2 = 3.5", y=80, colour="darkgrey", angle=90)
